...
jsonld = [
    {"@context": "https://schema.org", "@type": "ScholarlyArticle", "headline": TITLE, "name": TITLE, "description": DESC,
     "author": {"@type": "Person", "name": "Hanish Keloth", "jobTitle": "CTO", "url": "https://github.com/hanishkeloth", "sameAs": ["https://www.linkedin.com/in/hanishkeloth/", "https://huggingface.co/palette-lab"], "affiliation": {"@type": "Organization", "name": "Palette", "url": "https://www.pltt.xyz"}},
...
@page{{margin:0;size:A4}}@media print{{html{{-webkit-print-color-adjust:exact;print-color-adjust:exact}}main{{padding-top:10px}}figure.fig{{break-inside:avoid}}table{{break-inside:avoid}}}}
