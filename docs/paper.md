...
|---|---|---|
| Songgot-X 0.8B v10 | 62.4 | 81.4 |
| Kanana-2-1.3B-Instruct (Kakao) | 14.4 | 83.4 |
| Qwen3.5-0.8B (base, zero-shot) | 12.4 | 63.0 |

The name column is the fair comparison: Kanana-2 and Songgot-X choose the same function at the same rate (83.4 against
81.4, inside the 1.7-point standard error), and post-training lifts the base by 18 points. The call column is not a fair
