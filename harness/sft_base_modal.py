...
def sft(base: str = "Qwen/Qwen3-0.6B", out: str = "base_qwen06/final", data: str = "sft/train.jsonl", epochs: int = 2, lr: float = 1e-5,
        batch: int = 16, accum: int = 2, max_len: int = 1024, seed: int = 0):
    import math
    import torch
