...
## Status (2026-09-10 17:44)
Weights in this repo are Songgot, 2 epochs, v5 set + similarity-reward RL: 12 layers, about 50M parameters, pretrained on 8xH100 (Modal) on 6B tokens, post-trained on the v5 set, then similarity-reward RL (200 steps, 16x8 samples), post-trained on the v2 tool-calling set. Call accuracy on FunctionChat-Bench SingleCall 11.4 percent (name only 53.6). GGUF exports (f16, Q8_0, Q4_K_M) are in this repo.
## Format
```
<|system|>
