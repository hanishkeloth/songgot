...
|---|---|---|---|---|---|---|---|---|
| Songgot (2 epochs, v5 set) | 50M | 26.0 | 12.0 | 10.0 | 7.0 | 2.0 | 11.4 | 53.6 |
...
## Status (2026-09-10 17:18)
Weights in this repo are Songgot, 2 epochs, v5 set: 12 layers, about 50M parameters, pretrained on 8xH100 (Modal) on 6B tokens, post-trained on the v5 set (v4 plus randomised no-parameter schema shapes), post-trained on the v2 tool-calling set. Call accuracy on FunctionChat-Bench SingleCall 11.4 percent (name only 53.6). GGUF exports (f16, Q8_0, Q4_K_M) are in this repo.
## Format
```
<|system|>
